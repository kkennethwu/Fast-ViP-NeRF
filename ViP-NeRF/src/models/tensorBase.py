...
class MLPRender_Vis(torch.nn.Module):
    def __init__(self,inChanel, viewpe=6, feape=6, featureC=128):
        super(MLPRender_Vis, self).__init__()
...
class TensorBase(torch.nn.Module):
    def __init__(self, aabb, gridSize, device, density_n_comp = 8, appearance_n_comp = 24, app_dim = 27,
                    shadingMode = 'MLP_Vis', alphaMask = None, near_far=[2.0,6.0],
    ...
    def init_render_func(self, shadingMode, pos_pe, view_pe, fea_pe, featureC, device):
        ...
        elif shadingMode == 'MLP_Vis':
            self.renderModule = MLPRender_Vis(self.app_dim, view_pe, fea_pe, featureC).to(device)
